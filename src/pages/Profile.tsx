...
export default function Profile({ currentXP = mockUserStats.xp, currentLevel = mockUserStats.level }: ProfileProps) {
  return (
    <div style={{ padding: '24px', background: '#171821', borderRadius: '12px', color: '#fff', border: '1px solid #2f303e' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '16px', marginBottom: '32px' }}>
        <div style={{ background: '#21222d', padding: '16px', borderRadius: '12px', border: '1px solid #2f303e' }}>
          ...
          <div style={{ fontSize: '22px', fontWeight: 'bold', color: '#8c52ff' }}>{currentXP} XP</div>
        </div>
        <div style={{ background: '#21222d', padding: '16px', borderRadius: '12px', border: '1px solid #2f303e' }}>
